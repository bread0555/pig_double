# checkpoints due 11:59pm Saturday
...
def play_human_turn(player, dices):
    temp = 0 
    while True:
        decision = handle_player_decision()
        if decision == 0:
            ...
            if temp == 0:
                print("You haven't rolled the dice yet.") # works
            else:
...
def check_for_ones(player, dices):
    '''
    Checks for ones in current roll
    '''
    if dices[0] == 1 and dices[1] == 1:
        player.score = 0
